...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.settings.creen_height = self.screen.get_rect().height
        pygame.display.set_caption("Alien Invasion")

        # Create the game stats and scoreboard
    ...
    def _check_bullet_alien_collision(self):
        """Respond to bullet collison"""
        # Requirement 3c.iv
         # Check collisons and remove collisons
    ...
    def _ship_hit(self):
        """Respond when ship is hit by an alien"""
    ...
    def _check_fleet_edges(self):
        """check if fleet is at the edge and respond"""
        # Requirement 3c.iii
        for alien in self.aliens.sprites():
    ...
    def _change_fleet_direction(self):
        """change the direction and drop the fleet down"""
        # Requirement 3c.iii
        for alien in self.aliens.sprites():
